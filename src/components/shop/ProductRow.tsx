...
export function ProductRow({ product, index, onAdd, onHover, onLeave, onTap }: Props) {
  ...
  return (
    <div
      ...
      className={`group grid grid-cols-[56px_1fr_auto] md:grid-cols-[64px_1fr_120px_100px_auto] items-center gap-3 md:gap-4 px-3 md:px-4 py-3 border-b border-border/60 transition-colors ${

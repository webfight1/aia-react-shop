...
export const products: Product[] = [
  ...
  { id: "p5", name: "PORRULAUK 'Bulgina'", amount: "100 seemet", price: 1.79, image: img("1631114831963-3edc4d5b41ac"), description: "Keskvalmiv porrulauk pikkade valgete varte ja õrna maitsega. Vastupidav talvele." },

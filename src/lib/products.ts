...
export const products: Product[] = [
  ...
  { id: "p13", name: "BASIILIK 'Genovese'", amount: "0,5 grammi", price: 1.55, image: "https://picsum.photos/seed/basiilik/400/400", description: "Klassikaline Itaalia basiilik, ideaalne pesto ja salatite jaoks." },
  ...
  { id: "p15", name: "PETERSELL 'Gigante d'Italia'", amount: "2 grammi", price: 1.35, image: "https://picsum.photos/seed/petersell/400/400", description: "Lehtpetersell suurte tumeroheliste lehtedega, tugeva maitsega." },
  ...
  { id: "p17", name: "SUVIKÕRVITS 'Black Beauty'", amount: "12 seemet", price: 1.95, image: "https://picsum.photos/seed/suvikorvits/400/400", description: "Klassikaline tumeroheline suvikõrvits, viljakas ja kompaktne taim." },
  { id: "p18", name: "MAITSEHERNES 'Spencer Mix'", amount: "1 gramm", price: 2.55, image: "https://picsum.photos/seed/maitsehernes/400/400", description: "Lõhnav lillsegu suurte lainjate õitega. Ideaalne lõikelilledeks." },
